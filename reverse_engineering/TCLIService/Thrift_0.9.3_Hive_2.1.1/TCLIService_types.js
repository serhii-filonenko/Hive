...
var TSetClientInfoReq = module.exports.TSetClientInfoReq = function(args) {
  this.sessionHandle = null;
  this.configuration = null;
  if (args) {
    if (args.sessionHandle !== undefined && args.sessionHandle !== null) {
...
var TSetClientInfoResp = module.exports.TSetClientInfoResp = function(args) {
  this.status = null;
  if (args) {
    if (args.status !== undefined && args.status !== null) {
      this.status = new ttypes.TStatus(args.status);
...
var TGetQueryIdReq = module.exports.TGetQueryIdReq = function(args) {
  this.operationHandle = null;
  if (args) {
    if (args.operationHandle !== undefined && args.operationHandle !== null) {
      this.operationHandle = new ttypes.TOperationHandle(args.operationHandle);
...
var TGetQueryIdResp = module.exports.TGetQueryIdResp = function(args) {
  this.queryId = null;
  if (args) {
